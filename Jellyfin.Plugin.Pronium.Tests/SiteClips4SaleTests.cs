...
public class SiteClips4SaleTests
{
    ...
    private readonly string _testSceneUrl = "/studio/33729/26228503/mf-bad-girls-detention-at-the-principals-house-4k-lesbian-uniform-ellie-idol";
    ...
    public async Task SearchIsWorking()
    {
        var result = await _site.Search(
            new[] { 49, 0 },
            "Bad Girls Detention at the Principals",
...
#pragma warning disable NUnit2021 // Incompatible types for EqualTo constraint
        Assert.That(result.Item.PremiereDate.Value.ToString("yyyy-MM-dd"), Is.EqualTo("2022-05-20"));
#pragma warning restore NUnit2021 // Incompatible types for EqualTo constraint
    ...
    public async Task GetImagesIsWorking()
    {
        var result = (await _site.GetImages(
            new[] { 49, 0 },
            new[] { Helper.Encode(_testSceneUrl), "2022-05-20" },
            null,
            new CancellationToken())).ToList();

        Assert.That(result, Has.Count.EqualTo(2));
        Assert.That(result.First().Url, Is.EqualTo("https://imagecdn.clips4sale.com/accounts99/33729/clip_images/previewlg_26228503.jpg"));
    }
}
